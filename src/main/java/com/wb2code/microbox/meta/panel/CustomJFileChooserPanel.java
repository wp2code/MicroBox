...
//        this.selectFile.setEditable(false);
        ...
        ComPanel commonPanel = new ComPanel();
...
//        jFileChooser.addChoosableFileFilter(new FileNameExtensionFilter(".jar", "jar"));
        // 设置默认使用的文件过滤器
        if (fileNameExtensionFilter == null) {
            jFileChooser.setFileFilter(fileNameExtensionFilter = new FileNameExtensionFilter(".jar", "jar"));
        }
